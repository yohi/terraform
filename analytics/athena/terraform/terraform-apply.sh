...
# AWS Account Confirmation Script for Terraform Apply
# This script ensures AWS account verification before running terraform apply
...
echo -e "${RED}⚠️  This will apply changes to your AWS infrastructure!${NC}"
echo ""
...
while true; do
    ...
    case "$confirmation" in
        [yY]|[yY][eE][sS])
            echo ""
            echo -e "${GREEN}✅ AWS account confirmed. Running terraform apply...${NC}"
            echo ""
            break
            ;;
        [nN]|[nN][oO]|"")
