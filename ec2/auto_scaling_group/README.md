...
- ✅ **自動サイズ計算** - desired_capacityベースでmin/max_sizeを自動計算
...
| 変数名                      | 説明                                                                                | デフォルト値 |
| --------------------------- | ----------------------------------------------------------------------------------- | ------------ |
| `desired_capacity`          | 希望インスタンス数（最小インスタンス数は同じ値、最大インスタンス数は2倍に自動設定） | `2`          |
...
module "auto_scaling_group" {
  ...
  # スケーリング設定（希望インスタンス数のみ設定）
  # 最小インスタンス数: 4（desired_capacityと同じ）
